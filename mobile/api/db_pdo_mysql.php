...
//SQLSTATE[42S02]: Base table or view not found: 1146 Table 'authors' doesn't exist
    ...
    function getByKeyword($keyword,$installTableOnFailure = FALSE)
    {
        ...
        try {
            ...
            $query = "SELECT * FROM notes WHERE tags LIKE '%{$keyword}%' OR name LIKE '%{$keyword}%' OR description LIKE '%{$keyword}%' AND approved != '0'";
...
//SQLSTATE[42S02]: Base table or view not found: 1146 Table 'authors' doesn't exist
    ...
    private function install ()
    {
        ...
        $this->db->exec(
        "INSERT INTO notes (name, description,address,latitude,longitude,tags,ratings,approved) VALUES ('Beach Walk','Beach loop from the back beach ending at the playground','Back Beach Road, Tahunanui, Nelson','-41.285974','173.23166','walk, beach, playground',3,1);
        INSERT INTO notes (name, description,address,latitude,longitude,tags,ratings,approved) VALUES ('Wasington Valley Playground','A great little playground that has become a family fav with a new play house and good swings','Pioneer Park, Washington Valley, Nelson','-41.272525','173.275487','playground',4,1);
        INSERT INTO notes (name, description,address,latitude,longitude,tags,ratings,approved) VALUES ('Model Train Ride','A hit with the whole family are the great train rides at the modelers pond - they even have Thomas!','Modelers pond, Tahunanui, Nelson','-41.281806','173.24388','trains, beach',5,1);
            ");
    }
}